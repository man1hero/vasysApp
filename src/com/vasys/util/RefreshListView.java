...
public class RefreshListView extends ListView implements OnScrollListener{
	...
	private int firstVisibleItemPosition;//屏幕显示在第一个item的索引
	...
	private View footerView;//foot布局
	private int footerViewHeight;//foot布局的高度
	private boolean isLoadingMore=false;//是否正在加载更多种
	...
	private void initFooterView(){
		...
		footerView.setPadding(0, -footerViewHeight-10, 0, 0);
	...
	private void initHeaderView() {
		...
		ivArrow = (ImageView) headerView.findViewById(R.id.listview_header_arrow);
		...
		tvLastUpdateTime = (TextView) headerView.findViewById(R.id.tv_listview_header_last_update);
