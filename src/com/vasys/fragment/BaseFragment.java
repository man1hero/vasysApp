...
public class BaseFragment extends Fragment {
	...
	public static BaseFragment newInstance(Context context, String tag) {
		...
		if (TextUtils.equals(tag, Constant.FRAGMENT_FLAG_ALARM)) {
			baseFragment = new AlarmFragment();
		} else if (TextUtils.equals(tag, Constant.FRAGMENT_FLAG_CAM)) {
			baseFragment = new CamFragment();
		} else if (TextUtils.equals(tag, Constant.FRAGMENT_FLAG_REPORT)) {
			baseFragment = new ReportFragment();
		} else if (TextUtils.equals(tag, Constant.FRAGMENT_FLAG_SETTINGS)) {
